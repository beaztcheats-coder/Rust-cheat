...
inline void Aim()
{
    ...
    ImGui::BeginGroup();
    BeginCard("aim_position", "VISIBILITY", ImVec2(col, 130.f));
    ImGui::Checkbox("Visible Only", &AIMBOT::VisibleOnly);
    ImGui::Checkbox("Visible Strict", &AIMBOT::VisibleStrict);
    ...
    BeginCard("aim_recoil", "RECOIL", ImVec2(col, 100.f));
...
inline void Settting()
{
    ...
    BeginCard("set_env", "ENVIRONMENT", ImVec2(col, 140.f));
