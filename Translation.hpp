...
inline const TranslationPair g_TranslationPairs[] = {
    ...
    {"Panther","Panthère"},{"Tiger","Tigre"},{"Snake","Serpent"},{"Crocodile","Crocodile"},{"Animal","Animal"},
    ...
    {"Zoom Amount","Quantité Zoom"},    {"No Sway","Sans Oscillation"},{"Force Automatic","Forcer Automatique"},{"Crosshair","Réticule"},{"Crosshair Size","Taille Réticule"},
    {"Show Time","Afficher Heure"},    {"Feature Indicators","Indicateurs"},    {"Player List","Liste Joueurs"},{"Mark Friend","Marquer Ami"},{"Stash Persist","Cache Persistante"},    {"Vehicle Health","Santé Véhicule"},    {"Player Flags","Drapeaux Joueur"},    {"Raid ESP","ESP Raid"},{"Raid Dist","Dist Raid"},    {"Crate Timer","Minuteur Crate"},
