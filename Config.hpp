...
namespace Config {
    ...
    inline bool Save() {
        ...
        SaveBool(h, "ESP.PlayerFlags", ESP::PlayerFlags);
        ...
        SaveBool(h, "ANIMAL.Crocodile", ANIMAL_ESP::Crocodile);
        ...
        SaveBool(h, "WORLD.StashPersist", WORLD::StashPersist);
        ...
        SaveBool(h, "WORLD.VehicleHealth", WORLD::VehicleHealth);
        SaveBool(h, "WORLD.RaidESP", WORLD::RaidESP);
        SaveFloat(h, "WORLD.draw_raid", WORLD::draw_raid);
        SaveBool(h, "WORLD.CrateTimer", WORLD::CrateTimer);
        ...
        SaveBool(h, "BIGMAP.ShowPlayers", BIGMAP::ShowPlayers);
        SaveBool(h, "BIGMAP.ShowNPCs", BIGMAP::ShowNPCs);
        SaveBool(h, "BIGMAP.ShowAnimals", BIGMAP::ShowAnimals);
        SaveBool(h, "BIGMAP.ShowOres", BIGMAP::ShowOres);
        SaveBool(h, "BIGMAP.ShowHemp", BIGMAP::ShowHemp);
        SaveBool(h, "BIGMAP.ShowStashes", BIGMAP::ShowStashes);
        SaveBool(h, "BIGMAP.ShowTCs", BIGMAP::ShowTCs);
        SaveBool(h, "BIGMAP.ShowCrates", BIGMAP::ShowCrates);
        SaveBool(h, "BIGMAP.ShowVehicles", BIGMAP::ShowVehicles);
        SaveBool(h, "BIGMAP.ShowTurrets", BIGMAP::ShowTurrets);
        SaveBool(h, "BIGMAP.ShowNames", BIGMAP::ShowNames);
        SaveBool(h, "BIGMAP.ShowDistance", BIGMAP::ShowDistance);
        SaveFloat(h, "BIGMAP.DotSize", BIGMAP::DotSize);
        ...
        SaveBool(h, "MISC.ForceAutomatic", MISC::ForceAutomatic);
        ...
        SaveBool(h, "MISC.DebugCameraNative", MISC::DebugCameraNative);
        ...
        SaveBool(h, "SETTINGS.ShowTime", SETTINGS::ShowTime);
        SaveBool(h, "SETTINGS.FeatureIndicators", SETTINGS::FeatureIndicators);
        SaveBool(h, "SETTINGS.PlayerList", SETTINGS::PlayerList);
    ...
    inline void ParseLine(char* line) {
        ...
        *eq = 0;
        ...
        LOAD_BOOL("ESP.PlayerFlags", ESP::PlayerFlags);
        ...
        LOAD_BOOL("ANIMAL.Crocodile", ANIMAL_ESP::Crocodile);
        ...
        LOAD_BOOL("WORLD.StashPersist", WORLD::StashPersist);
        ...
        LOAD_BOOL("WORLD.VehicleHealth", WORLD::VehicleHealth);
        LOAD_BOOL("WORLD.RaidESP", WORLD::RaidESP);
        LOAD_FLOAT("WORLD.draw_raid", WORLD::draw_raid);
        LOAD_BOOL("WORLD.CrateTimer", WORLD::CrateTimer);
        ...
        LOAD_BOOL("BIGMAP.ShowPlayers", BIGMAP::ShowPlayers);
        LOAD_BOOL("BIGMAP.ShowNPCs", BIGMAP::ShowNPCs);
        LOAD_BOOL("BIGMAP.ShowAnimals", BIGMAP::ShowAnimals);
        LOAD_BOOL("BIGMAP.ShowOres", BIGMAP::ShowOres);
        LOAD_BOOL("BIGMAP.ShowHemp", BIGMAP::ShowHemp);
        LOAD_BOOL("BIGMAP.ShowStashes", BIGMAP::ShowStashes);
        LOAD_BOOL("BIGMAP.ShowTCs", BIGMAP::ShowTCs);
        LOAD_BOOL("BIGMAP.ShowCrates", BIGMAP::ShowCrates);
        LOAD_BOOL("BIGMAP.ShowVehicles", BIGMAP::ShowVehicles);
        LOAD_BOOL("BIGMAP.ShowTurrets", BIGMAP::ShowTurrets);
        LOAD_BOOL("BIGMAP.ShowNames", BIGMAP::ShowNames);
        LOAD_BOOL("BIGMAP.ShowDistance", BIGMAP::ShowDistance);
        LOAD_FLOAT("BIGMAP.DotSize", BIGMAP::DotSize);
        ...
        LOAD_BOOL("MISC.ForceAutomatic", MISC::ForceAutomatic);
        ...
        LOAD_BOOL("MISC.DebugCameraNative", MISC::DebugCameraNative);
        ...
        LOAD_BOOL("SETTINGS.ShowTime", SETTINGS::ShowTime);
        LOAD_BOOL("SETTINGS.FeatureIndicators", SETTINGS::FeatureIndicators);
        LOAD_BOOL("SETTINGS.PlayerList", SETTINGS::PlayerList);
    ...
    inline void ApplyLegitDefaults() {
        ...
        ESP::RemoveSleepers = true; ESP::RemoveWounded = true; ESP::RemoveTeam = false;
    ...
    inline bool Load() {
        ...
        if (h == INVALID_HANDLE_VALUE) {
            SetStatus("No config found â€” defaults loaded");
            return false;
        }

        DWORD fileSize = GetFileSize(h, NULL);
        if (fileSize == 0 || fileSize > 1024 * 64) { CloseHandle(h); SetStatus("Config invalid â€” defaults loaded"); return false; }
