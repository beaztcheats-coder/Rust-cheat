...
namespace offsets {
	inline uint64_t basenetworkable_pointer = 0x0FBE3040; // morphine build 24087225
	inline uint64_t camera_pointer = 0x0FBD99B0;           // morphine build 24087225 (MainCamera)
	inline uint64_t Il2cppGetHandle = 0x10077870;           // morphine build 24087225 (gc_handles::array_rva)
	inline uint64_t TOD_Sky_TypeInfo = 0x0FC6EF38;         // morphine build 24087225
	inline uint64_t Class_TOD_Sky_Static = 0x0FC6EF38;    // morphine build 24087225 (same as TypeInfo)
	inline uint64_t EffectNetwork_Pointer = 0xFB605F8;   // morphine build 24087225 (static_type_info)
	inline uint64_t Class_SingletonComponent_UI_LoadingScreen = 0xFC5C060; // morphine build 24087225
	inline uint64_t Class_SingletonComponent_MixerSnapshotManager__c = 0xFBD5160; // morphine build 24087225
	...
	namespace BaseNetworkable
	{
		...
		inline uint64_t  entity = 0x20;        // morphine build 24069519 — entities offset in parent_class
		inline uint64_t  children = 0x88;        // morphine build 24087225
  ...
  namespace BaseCamera
  {
  	...
  	inline uint64_t  wrapper_class = 0x30;   // morphine build 24069519 — camera_object offset in static_fields
...
namespace BasePlayer {
	inline uint64_t PlayerEyes = 0x490;        // morphine build 24087225
	inline uint64_t PlayerInventory = 0x580;   // morphine build 24087225
	inline uint64_t PlayerInput = 0x3e0;       // morphine build 24087225
	inline uint64_t PlayerModel = 0x508;       // morphine build 24087225
	inline uint64_t ModelTransform = 0x1A8;
	inline uint64_t PlayerFlags = 0x6B8;       // morphine build 24087225 (unchanged)
	inline uint64_t ClActiveItem = 0x568;      // morphine build 24087225 (unchanged)
	inline uint64_t BaseMovement = 0x458;      // morphine build 24087225
	inline uint64_t DisplayName = 0x588;       // morphine build 24087225
	inline uint64_t ModelState = 0x3D8;  // morphine build 24087225 (verify)
	inline uint64_t Mounted = 0x5C0;           // verify (morphine unresolved)
	inline uint64_t BeltDirect = 0x2B8;
	inline uint64_t CurrentTeam = 0x538;       // morphine build 24087225 (unchanged)
	inline uint64_t WeaponMoveSpeedScale = 0x798; // morphine build 24087225 (unchanged)
	inline uint64_t ClothingBlocksAiming = 0x79C; // morphine build 24087225 (unchanged)
	inline uint64_t SteamID = 0x558;           // morphine build 24087225
	inline uint64_t PlayerRigidbody = 0x4a8;   // morphine build 24087225
	inline uint64_t Frozen = 0x388;            // morphine build 24087225 (unchanged)
	inline uint64_t CurrentGesture = 0x658;    // morphine build 24087225
  }
...
namespace unity_string {
  ...
  {
      constexpr uint64_t flags = 0x3C;          // morphine build 24069519 model_state.flags
  ...
  {
      inline uint64_t Belt = 0x30;        // morphine build 24087225 containerBelt
      inline uint64_t Wear = 0x58;        // morphine build 24087225 containerWear
      inline uint64_t Main = 0x28;        // morphine build 24087225 containerMain
      inline uint64_t loot = 0x48;        // morphine build 24087225 loot
      constexpr uint64_t BeltFallback1 = 0x58;  // containerWear fallback
      constexpr uint64_t BeltFallback2 = 0x28;  // containerMain fallback
  }

  namespace ItemContainer
  {
      constexpr uint64_t ItemList = 0x40; // morphine build 24087225 item_list
      constexpr uint64_t ItemListFallback = 0x10; // Fallback when primary fails
  }

    namespace PlayerModel
   	{
    	inline uint64_t SkinnedMultiMesh = 0x440; // morphine build 24087225 _multiMesh
      		inline uint64_t is_npc = 0x00000474;           // morphine build 24087225 isNpc
    ...
    namespace Item
    {
        constexpr uint64_t ItemDefinition = 0xA0;       // morphine build 24087225 itemdefinition
        constexpr uint64_t ItemId = 0x68;               // morphine build 24087225 uid
        constexpr uint64_t HeldEntity_1 = 0x58;         // morphine build 24087225 held_entity
        constexpr uint64_t Amount = 0x78;               // morphine build 24087225 amount
  ...
  namespace HeldEntity
  {
      ...
      constexpr uint64_t viewModel = 0x000001F0;           // morphine build 24069519
  }
  ...
  namespace BaseEntity
  {
      ...
      constexpr uint64_t positionLerp = 0x1E0;   // morphine desktop dump build 24069519
  ...
  namespace FOV
  {
      inline uint64_t ConVar_Graphics = 0xFBD99A8;  // morphine build 24087225
      constexpr uint64_t fovField = 0x560;
      constexpr uint64_t fovWrite = 0xA8;            // morphine build 24087225 convar_graphics::fov
  ...
  {
       constexpr uint64_t contents = 0x0; // morphine build 24069519
  }
  ...
  namespace EffectNetwork
  {
      ...
      constexpr uint64_t hitPosition = 0x88;    // morphine build 24087225
  }

  namespace convar_admin
  {
      constexpr uint64_t convar_admin = 0xFC4C440; // morphine build 24087225
...
#define Create(name,value) uintptr_t m_##name = value
	...
	inline int VisMode = 1;            // 0=Raw, 1=Hybrid (consensus), 2=Strict
